...
object JsonWriter {
  ...
  def streaming[T <: java.io.Writer](writer: T, alwaysEscapeUnicode: Boolean): JsonWriter[T] = new RootStreamingJsonWriter[T](writer, pretty = false, alwaysEscapeUnicode = alwaysEscapeUnicode)
  def streamingPretty[T <: java.io.Writer](writer: T, alwaysEscapeUnicode: Boolean): JsonWriter[T] = new RootStreamingJsonWriter[T](writer, pretty = true, alwaysEscapeUnicode = alwaysEscapeUnicode)
}
trait JsonWriter[T] {
...
private final class FieldStreamingJsonWriter[T <: JWriter](
  ...
  protected[this] val alwaysEscapeUnicode: Boolean) extends StreamingJsonWriter[T] {
