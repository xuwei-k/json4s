...
object build {
  ...
  def json4sSettings(cross: Boolean = false) = mavenCentralFrouFrou ++ Def.settings(
    ...
    Compile / sources := {
      ...
      if (scalaVersion.value == "3.0.0-RC1") {
        val singletonIsEmpty = (ThisBuild / baseDirectory).value / "ast/shared/src/main/scala-2.13+/org/json4s/SomeValue.scala"
        val booleanIsEmpty = (ThisBuild / baseDirectory).value / "ast/shared/src/main/scala-2.13-/org/json4s/SomeValue.scala"
